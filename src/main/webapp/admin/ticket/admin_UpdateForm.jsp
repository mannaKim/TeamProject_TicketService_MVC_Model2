...
<form method="post" enctype="multipart/form-data" action="ticket.do?command=ticketShowUpdate">
	...
	<table border="1">
		...
		<tr>
			<th>공연시작시간</th>
			<td><input type="text" name="daytime" value="${ticketVO.daytime}" size="20"></td>
		</tr>
		<tr>
			<th>연령</th>
			<td><input type="text" name="age" value="${ticketVO.age}" size="20"></td>
		</tr>
		<tr>
			<th>관람시간</th>
			<td><input type="text" name="showtime" value="${ticketVO.showtime}" size="20"></td>
		</tr>
		<tr>
			<th>금액</th>
			<td>
				일반 <input type="text" name="price1" value="${ticketVO.price1}" size="20">, 
				어린이 <input type="text" name="price2" value="${ticketVO.price2}" size="20">
				할인금액 <input type="text" name="price3" value="${ticketVO.price3}" size="20">
			</td>
		</tr>
		<tr>
			<th>작품설명</th>
	...
	<input type="button" value="목록" onClick="location.href='ticket.do?command=admin_ticketList'">
