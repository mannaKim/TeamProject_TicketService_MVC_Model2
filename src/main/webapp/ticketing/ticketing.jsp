...
<div id="ticketingCart">
	...
	<div id="ticketingCartbody">
		<div id="t_main">
			...
			<div id="t_menu">
				...
				<table>
					...
					<tr><td>일　반</td><td>${ticket_productVO.price1} 원</td></tr>
					<tr><td></td><td>${select1} 매</td></tr>
					<tr><td>어린이</td><td>${ticket_productVO.price2} 원</td></tr>
		...
		<div id="t_menubox">
			...
			<div id="t_button">
				<input type="submit" value="완료" id="btn_ticket" onclick="return go_mypage()">
