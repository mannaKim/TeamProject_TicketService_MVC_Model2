...
insert into member(id,pwd,name,phone,email) values
('admin','admin','관리자','010-0000-0000','admin@.com');

insert into member(id,pwd,name,zip_num,address1,address2,phone,email) values
('scott','1234','홍길동','133-110','서울시 성동수 성수동1가','1번지 21호','010-4444-5555','abc@abc.com');
