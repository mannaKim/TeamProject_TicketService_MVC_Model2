...
public class AdminGoodsDetailAction implements Action {

	@Override
	public void execute(HttpServletRequest request, HttpServletResponse response)
			throws ServletException, IOException, ParseException {
		String url = "admin/goods/goodsDetail.jsp";
		...
		if(mvo==null || mvo.getAdmin()!=1) {
			...
			int index = Integer.parseInt(gvo.getKind())-1;
			request.setAttribute("goodsKind", goodsKindList[index]);
		}
